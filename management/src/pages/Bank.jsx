      ...
      <SideBar>
        <div className="mx-6">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography sx={{ color: "text.primary" }}>Bank A/c</Typography>
          </Breadcrumbs>
        </div>
        ...
        >
          <Box sx={{ ...style }} className="rounded-[.5rem] ">
            <div className="overflow-scroll h-[85vh] md:h-[38.5rem] no-scrollbar">
              <div className="h-fit">
                <h5 className=" text-2xl font-bold">Update Accounts</h5>
                <form
                  action=""
                ...
                >
                  <Grid2 container spacing={2} className="w-full">
                    ...
                    <Grid2 size={{ xs: 12, sm: 6 }} className="inputData">
                      <label htmlFor="projectStatus">A/c Holder Name</label>
                      <input
                        type="text"
                        required
                        placeholder=" Name"
                    ...
                    <div className="p- h-fit">
                      {activeTab === "Project Details" && (
                        <div className="space-y-2">
                          ...
                          <Grid2 container spacing={2} className="">
                            <Grid2 size={4} className="font-bold space-y-2">
                              <div className="">A/c Holder Name : </div>
                            </Grid2>
                            <Grid2 size={8} className="space-y-2">
                              <div>Megha</div>
                            </Grid2>
